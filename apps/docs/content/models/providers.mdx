...
Eleven providers ship in `@husk/models`. Three have their own wire format and their own
...
is a translation `@husk/models` owns.
...
Husk sends OpenRouter's two attribution headers, `http-referer: https://husk.sh` and
