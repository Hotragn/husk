...
- [ ] Husk installed (`npm install -g @husk-ai/cli`) and `husk doctor` showing a reachable
      model.
...
npm install @husk-ai/adapters @husk-ai/core
```

```js title="bot.mjs"
import { DiscordAdapter } from '@husk-ai/adapters';
