 ...
 * `@husk/browser` keeps a Chromium running inside the machine and a `pkill` in
 ...
 *
 * A registry rather than a direct call because of layering. `@husk/runtime`
 * owns the lifecycle and must not import `@husk/browser` -- the browser is an
